        ...
        <div class="component-demo">
            ...
            <div class="control-panel control-panel-expanded">
                ...
                <div class="control-panel-footer">
                    <button class="tp-button tp-button-small tp-button-secondary"><?php esc_html_e('Reset', 'evolvewp-predictiveerp'); ?></button>
                    <button class="tp-button tp-button-small tp-button-primary"><?php esc_html_e('Apply', 'evolvewp-predictiveerp'); ?></button>
                </div>
            </div>
        </div>
    </div>
