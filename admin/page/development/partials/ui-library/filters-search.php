                ...
                <div class="filter-panel">
                    ...
                    <div class="filter-panel-content">
                        ...
                        <div class="filter-actions">
                            <button type="button" class="tp-button tp-button-secondary"><?php esc_html_e('Reset', 'evolvewp-predictiveerp'); ?></button>
                            <button type="button" class="tp-button tp-button-primary"><?php esc_html_e('Apply Filters', 'evolvewp-predictiveerp'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
