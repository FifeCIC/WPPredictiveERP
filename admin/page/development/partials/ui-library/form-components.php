        ...
        <div class="evolvewp-predictiveerp-form-showcase">
            <form method="post" action="" class="evolvewp-predictiveerp-demo-form">
                ...
                <div class="evolvewp-predictiveerp-form-actions">
                    <button type="submit" class="tp-button tp-button-primary"><?php esc_html_e('Send Message', 'evolvewp-predictiveerp'); ?></button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="evolvewp-predictiveerp-component-group">
        ...
        <div class="evolvewp-predictiveerp-form-showcase">
            <form method="post" action="" class="evolvewp-predictiveerp-demo-form">
                ...
                <div class="evolvewp-predictiveerp-form-actions">
                    <button type="submit" class="tp-button tp-button-primary"><?php esc_html_e('Save Settings', 'evolvewp-predictiveerp'); ?></button>
                    <button type="reset" class="tp-button tp-button-secondary"><?php esc_html_e('Reset', 'evolvewp-predictiveerp'); ?></button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="evolvewp-predictiveerp-component-group">
        ...
        <div class="evolvewp-predictiveerp-form-showcase">
            <form id="ajax-validation-form" class="evolvewp-predictiveerp-demo-form">
                ...
                <div class="evolvewp-predictiveerp-form-actions">
                    <button type="submit" class="tp-button tp-button-primary" id="ajax-submit-btn"><?php esc_html_e('Validate & Submit', 'evolvewp-predictiveerp'); ?></button>
                </div>
            </form>
        </div>
    </div>
