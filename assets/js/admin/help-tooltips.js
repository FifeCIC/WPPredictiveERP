/**
 * EvolveWP PredictiveERP — Help Tooltips
 *
 ...
 *   <span class="evolvewp-predictiveerp-help-tip" data-tooltip="Explanation text">
 *       <span class="dashicons dashicons-editor-help"></span>
 *   </span>
 *
 * @package evolvewp-predictiveerp/JS/Admin
 * @since   3.1.0
 */
...
( function( $ ) {
	...
	function showTooltip( trigger ) {
		...
		tooltip.className = 'evolvewp-predictiveerp-help-tooltip evolvewp-predictiveerp-help-tooltip--top';
		...
		if ( top < scrollTop ) {
			...
			tooltip.className = 'evolvewp-predictiveerp-help-tooltip evolvewp-predictiveerp-help-tooltip--bottom';
		}
		...
		tooltip.classList.add( 'evolvewp-predictiveerp-visible' );
	 ...
	 */
	function init() {
		var triggers = document.querySelectorAll( '.evolvewp-predictiveerp-help-tip, [data-tooltip]' );
