jQuery( document).ready( function( $ ) {
    ...
    questions.each( function () {
        ...
        if ( answer === 39 ) {
            advancedGroup = $( '<optgroup />' )
                .attr( 'label', "<?php esc_html_e( 'Advanced: This part of FAQ requires some knowledge about HTML, PHP and/or WordPress coding.', 'evolvewp-predictiveerp' ); ?>" );
    ...
    indexSelector.before(
        $('<label />')
            ...
            .text( "<?php esc_html_e( 'Select a question', 'evolvewp-predictiveerp' ); ?>" )
