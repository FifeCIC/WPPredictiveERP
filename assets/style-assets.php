<?php
/**
 * EvolveWP PredictiveERP Style Assets Registry
 *
 ...
 *   - 'evolvewp_erp_development' → loads only on the Development page
...
return array(
	...
	'layouts' => array(
		...
		'features-layout' => array(
			...
			'pages'        => array( 'evolvewp_erp_settings' ),
			'dependencies' => array( 'variables' ),
		),
	...
	'pages' => array(
		'dashboard' => array(
			...
			'pages'        => array( 'evolvewp_erp_dashboard', 'toplevel_page_evolvewp-predictiveerp' ),
			'dependencies' => array( 'variables' ),
		),
		...
		'settings-general' => array(
			...
			'pages'        => array( 'evolvewp_erp_settings', 'evolvewp-predictiveerp-settings' ),
			'dependencies' => array( 'variables' ),
		),
		...
		'setup' => array(
			...
			'pages'        => array( 'evolvewp_erp_setup', 'evolvewp-predictiveerp-setup' ),
			'dependencies' => array( 'variables' ),
		),
		'assets-page' => array(
	...
	'standalone' => array(
		...
		'evolvewp-predictiveerp-setup' => array(
			'path'         => 'css/evolvewp-predictiveerp-setup.css',
