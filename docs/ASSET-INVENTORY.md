...
| `reset.css` | core | Yes | All --tp- refs need replacing with --evolvewp-predictiveerp- |
| `typography.css` | core | Yes | All --tp- refs need replacing with --evolvewp-predictiveerp- |
...
| `evolvewp-predictiveerp-setup.css` | core | Setup wizard |
| `evolvewp-predictiveerp-setup.scss` | **dead** | SCSS source — no build pipeline |
...
| `js/admin/evolvewp-predictiveerp-enhanced-select.js` | core | Select2 wrapper |
| `js/admin/evolvewp-predictiveerp-enhanced-select.min.js` | core | Minified version |
| `js/admin/evolvewp-predictiveerp-faq.js` | feature | FAQ accordion |
| `js/admin/evolvewp-predictiveerp-faq.min.js` | feature | Minified version |
| `js/admin/evolvewp-predictiveerp-setup.js` | core | Setup wizard JS |
| `js/admin/evolvewp-predictiveerp-setup.min.js` | core | Minified version |
...
- **Task 7.2** ✅ — All `--tp-` variable refs replaced with `--evolvewp-predictiveerp-` (46 CSS files)
- **Task 7.2** ✅ — All `.tp-` class names replaced with `.evolvewp-predictiveerp-` (6 CSS, 1 JS, 7 PHP templates)
- **Task 7.3** ✅ — `variables.css` cleaned: removed self-referencing aliases, trading vars,
  duplicate swatches. Added `--evolvewp-predictiveerp-focus-ring` and `--evolvewp-predictiveerp-color-accent`.
