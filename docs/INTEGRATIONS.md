...
if (class_exists('WooCommerce')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/woocommerce-example.php';
}
```
...
if (function_exists('acf_add_local_field_group')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/acf-example.php';
}
```
...
if (did_action('elementor/loaded')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/elementor-example.php';
}
```
...
if (function_exists('wpcf7')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/contact-form-7-example.php';
}
```
...
if (defined('WPSEO_VERSION')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/yoast-seo-example.php';
}
```
...
if (class_exists('GFForms')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/gravity-forms-example.php';
}
```
...
if (function_exists('buddypress')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/buddypress-example.php';
}
```
...
if (class_exists('Easy_Digital_Downloads')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/easy-digital-downloads-example.php';
}
```
...
if (class_exists('bbPress')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/bbpress-example.php';
}
```
...
if (defined('LEARNDASH_VERSION')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/learndash-example.php';
}
```
...
if (defined('MEPR_VERSION')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/memberpress-example.php';
}
```
...
if (function_exists('wpforms')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/wpforms-example.php';
}
```
...
```php
do_action('evolvewp_erp_integration_event', $data);
```

### 5. Use Transients for Caching

```php
$data = get_transient('evolvewp_erp_cache_key');
if (false === $data) {
    $data = expensive_operation();
    set_transient('evolvewp_erp_cache_key', $data, HOUR_IN_SECONDS);
}
```
...
```php
class EvolveWP_ERP_YourPlugin_Integration {
...
new EvolveWP_ERP_YourPlugin_Integration();
```
...
```php
if (class_exists('YourPlugin')) {
    include_once EVOLVEWP_ERP_PLUGIN_DIR . 'examples/integrations/your-plugin-example.php';
}
```
