...
All implementations use the **same core rendering function**: `EvolveWP_ERP_Unified_Feature::render_content()`
...
```
[evolvewp_erp_feature]
[evolvewp_erp_feature title="Custom Title"]
[evolvewp_erp_feature show_icon="no"]
[evolvewp_erp_feature show_stats="no"]
```
