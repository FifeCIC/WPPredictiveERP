 ...
 * namespace configuration, and REST Bridge integration for all EvolveWP PredictiveERP REST
 * API endpoints. Concrete controllers extend this and implement register_routes().
 *
 * DEPENDS ON:
 *   - WordPress WP_REST_Controller class
 *   - EvolveWP PredictiveERP\API\REST_Bridge (for register_endpoint convenience method)
 *
 * CONSUMED BY:
