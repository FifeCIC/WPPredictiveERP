<?php
/**
 * EvolveWP PredictiveERP Architecture Mapper
 * 
 * Visual guide to plugin structure for developers and AI
 * 
 * @package EvolveWP PredictiveERP/Development
 * @version 1.0.0
 */
...
class EvolveWP_ERP_Architecture_Mapper {
            ...
            'core_systems' => array(
                ...
                'children' => array(
                    'asset_system' => array(
                        ...
                        'children' => array(
                            'asset_manager' => array(
                                'name' => 'EvolveWP_ERP_Asset_Manager',
                                'type' => 'class',
                                'file' => 'includes/classes/asset-manager.php',
                    ...
                    'ai_system' => array(
                        ...
                        'children' => array(
                            'ai_assistant' => array(
                                'name' => 'EvolveWP_ERP_AI_Assistant',
                                'type' => 'class',
                            ...
                            'provider_factory' => array(
                                'name' => 'EvolveWP_ERP_AI_Provider_Factory',
                                'type' => 'factory',
                    ...
                    'api_system' => array(
                        ...
                        'children' => array(
                            ...
                            'api_factory' => array(
                                'name' => 'EvolveWP_ERP_API_Factory',
                                'type' => 'factory',
                                'file' => 'api/api-factory.php',
                                'methods' => array('create'),
                                'usage_pattern' => '$api = EvolveWP_ERP_API_Factory::create("provider_name", $args);'
                            ),
                            'api_logging' => array(
                                'name' => 'API Logging',
                                'type' => 'component',
                                'file' => 'includes/api-logging.php',
                                'tables' => array('evolvewp_erp_api_calls', 'evolvewp_erp_api_errors'),
                    ...
                    'ecosystem_framework' => array(
                        ...
                        'children' => array(
                            'ecosystem_registry' => array(
                                'name' => 'EvolveWP_ERP_Ecosystem_Registry',
                                'type' => 'class',
                                'file' => 'includes/classes/ecosystem-registry.php',
                            ...
                            'menu_manager' => array(
                                'name' => 'EvolveWP_ERP_Ecosystem_Menu_Manager',
                                'type' => 'class',
                            ...
                            'installer' => array(
                                'name' => 'EvolveWP_ERP_Ecosystem_Installer',
                                'type' => 'class',
                    ...
                    'logging_system' => array(
                        ...
                        'children' => array(
                            'file_logging' => array(
                                ...
                                'type' => 'component',
                                'file' => 'includes/logging-helper.php',
                                'functions' => array('evolvewp_erp_log', 'evolvewp_erp_log_error'),
                                'log_location' => 'wp-content/uploads/evolvewp-predictiveerp-logs/'
                            ),
                            'database_logging' => array(
                                'name' => 'Database Logging',
                                'type' => 'component',
                                'tables' => array('evolvewp_erp_logs'),
                    ...
                    'background_processing' => array(
                        ...
                        'children' => array(
                            'async_request' => array(
                                'name' => 'EvolveWP_ERP_Async_Request',
                                'type' => 'class',
                            ...
                            'background_process' => array(
                                'name' => 'EvolveWP_ERP_Background_Process',
                                'type' => 'class',
                                'file' => 'includes/classes/background-process.php',
                    ...
                    'object_registry' => array(
                        ...
                        'children' => array(
                            'registry' => array(
                                'name' => 'EvolveWP_ERP_Object_Registry',
                                'type' => 'class',
                                'file' => 'includes/classes/object-registry.php',
                                'methods' => array('add', 'get', 'update_var', 'remove', 'exists'),
                                'usage_pattern' => 'EvolveWP_ERP_Object_Registry::add("key", $object);',
                    ...
                    'data_freshness' => array(
                        ...
                        'children' => array(
                            'freshness_manager' => array(
                                'name' => 'EvolveWP_ERP_Data_Freshness_Manager',
                                'type' => 'class',
                                'file' => 'includes/classes/data-freshness-manager.php',
                    ...
                    'developer_flow_logger' => array(
                        ...
                        'children' => array(
                            'flow_logger' => array(
                                'name' => 'EvolveWP_ERP_Developer_Flow_Logger',
                                'type' => 'class',
                                'file' => 'includes/classes/developer-flow-logger.php',
            ...
            'admin_pages' => array(
                ...
                'children' => array(
                    'development_page' => array(
                        ...
                        'menu_slug' => 'evolvewp-predictiveerp-development',
                        'children' => array(
                            'assets_tab' => array(
                                'name' => 'Assets Tab',
                                'type' => 'tab',
                    ...
                    'settings_page' => array(
                        ...
                        'menu_slug' => 'evolvewp-predictiveerp-settings',
                        'children' => array(
                            'general_tab' => array(
                                'name' => 'General Tab',
                                'type' => 'tab',
                    ...
                    'github_sync' => array(
                        ...
                        'menu_slug' => 'evolvewp-predictiveerp-github-sync',
                    ...
                    'learning_centre' => array(
                        ...
                        'menu_slug' => 'evolvewp-predictiveerp-learning',
                        'purpose' => 'Database-driven lessons with REST API export',
                        'tables' => array('evolvewp_erp_lessons')
                    )
                )
            ),
            'wordpress_features' => array(
                ...
                'children' => array(
                    'custom_post_types' => array(
                        ...
                        'example' => 'evolvewp_erp_example_cpt',
                    ...
                    'taxonomies' => array(
                        ...
                        'type' => 'feature',
                        'file' => 'includes/classes/install.php',
                        'example' => 'evolvewp_erp_example_taxonomy',
                    ...
                    'user_roles' => array(
                        ...
                        'type' => 'feature',
                        'file' => 'includes/classes/install.php',
                        'example' => 'evolvewp_erp_custom_role',
            ...
            'developer_tools' => array(
                ...
                'children' => array(
                    'wp_cli' => array(
                        ...
                        'commands' => array('wp evolvewp-predictiveerp info', 'wp evolvewp-predictiveerp cache clear'),
                    ...
                    'developer_mode' => array(
                        ...
                        'detection' => 'Checks for localhost, custom domains, or EVOLVEWP_ERP_DEV_MODE constant'
                    ),
                    'uninstall_feedback' => array(
                        ...
                        'tables' => array('evolvewp_erp_uninstall_feedback')
                    ),
    ...
    public static function render_tree() {
        ...
        echo '<div class="evolvewp-predictiveerp-architecture-tree">';
    ...
    private static function get_tree_styles() {
        return "
        .evolvewp-predictiveerp-architecture-tree {
