<?php
/**
 * EvolveWP PredictiveERP Carbon Fields Integration
 *
...
class EvolveWP_ERP_Carbon_Fields {
    ...
    public function register_fields() {
        ...
        do_action('evolvewp_erp_carbon_fields_register');
    }
...
add_action('init', function() {
    EvolveWP_ERP_Carbon_Fields::instance();
});
