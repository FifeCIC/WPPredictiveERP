...
class EvolveWP_ERP_Developer_Flow_Logger {
    ...
    private static function display_flow() {
        ...
        echo '<div class="evolvewp-predictiveerp-flow-log">';
        ...
        echo '</div>';
        echo '<style>
        .evolvewp-predictiveerp-flow-log { margin: 20px 0; padding: 15px; background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 5px; font-family: monospace; font-size: 12px; }
