...
class EvolveWP_ERP_Ecosystem_Installer {
    ...
    private function define_available_plugins() {
        $this->available_plugins = apply_filters('evolvewp_erp_ecosystem_available_plugins', array(
            'evolvewp-predictiveerp' => array(
                ...
                'download_url' => 'https://github.com/yourusername/evolvewp-predictiveerp/archive/main.zip',
                'required_by' => array(),
                'integrates_with' => array('evolvewp-predictiveerp'),
            ),
    ...
    public function render_installer_page() {
        ...
        <div class="wrap">
            ...
            <p><?php esc_html_e('Install related Ryan Bayne plugins with one click', 'evolvewp-predictiveerp'); ?></p>
...
return new EvolveWP_ERP_Ecosystem_Installer();
