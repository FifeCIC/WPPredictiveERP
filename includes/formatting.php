<?php
/**
 * EvolveWP PredictiveERP - Data Formatting Functions
 *
 * @author   Ryan Bayne
 * @category Core
...
* @version 1.0
*/
function evolvewp_erp_string_half( $string, $ret = null ) {        
    $a = array();
 ...
 */
function evolvewp_erp_normalize_postcode( $postcode ) {          
 ...
 * @return string
 */
function evolvewp_erp_format_phone_number( $tel ) {            
 ...
 * @return string
 */
function evolvewp_erp_strtolower( $string ) {                    
 ...
 * @return string
 */
function evolvewp_erp_trim_string( $string, $chars = 200, $suffix = '...' ) {      
 ...
 * @return string|array
 */
function evolvewp_erp_clean( $var ) {
    if ( is_array( $var ) ) {
        return array_map( 'evolvewp_erp_clean', $var );
    } else {
