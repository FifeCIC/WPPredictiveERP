<?php
/**
 * EvolveWP PredictiveERP - Validation Functions
 *
...
* @return boolean 
*/
function evolvewp_erp_is_extensionloaded( $giving_extension ){      
...
* @param url $url
*/
function evolvewp_erp_is_url( $url ){            
...
* @returns boolean
*/
function evolvewp_erp_is_decimalnumber( $img_url){       
...
* @returns boolean
*/
function evolvewp_erp_is_image_url( $img_url ){       
