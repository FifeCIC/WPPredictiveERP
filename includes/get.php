<?php
/**
 * EvolveWP PredictiveERP - Small Get Functions
 *
...
* @version 1.1
*/
function evolvewp_erp_get_ip_address() {         
...
*/
function evolvewp_erp_get_total_administrators( $partial_admin = false, $return_users = false ) {   
