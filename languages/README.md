...
- `evolvewp-predictiveerp.pot` - Template file containing all translatable strings
- `evolvewp-predictiveerp-{locale}.po` - Translation files for specific languages (e.g., `evolvewp-predictiveerp-es_ES.po` for Spanish)
- `evolvewp-predictiveerp-{locale}.mo` - Compiled translation files (generated from .po files)
...
```bash
wp i18n make-pot . languages/evolvewp-predictiveerp.pot --domain=wpseed
```

Or using the makepot command:

```bash
php wp-content/plugins/evolvewp-predictiveerp/bin/makepot.php
```

## Creating a New Translation

1. Copy `evolvewp-predictiveerp.pot` to `evolvewp-predictiveerp-{locale}.po` (e.g., `evolvewp-predictiveerp-fr_FR.po` for French)
...
2. Open `evolvewp-predictiveerp.pot`
3. Create new translation from template
4. Save as `evolvewp-predictiveerp-{locale}.po`
...
wp i18n make-po languages/evolvewp-predictiveerp.pot languages/evolvewp-predictiveerp-es_ES.po
