                ...
                <div class="interactive-tooltip-templates" style="display: none;">
                    <div class="interactive-tooltip-content" data-content="strategy-help">
                        ...
                        <div class="tooltip-actions">
                            <button class="evolvewp-predictiveerp-button evolvewp-predictiveerp-button-small evolvewp-predictiveerp-button-primary"><?php esc_html_e('Learn More', 'evolvewp-predictiveerp'); ?></button>
                        </div>
                    </div>
                    ...
                    <div class="interactive-tooltip-content" data-content="risk-settings">
                        ...
                        <div class="tooltip-actions">
                            <button class="evolvewp-predictiveerp-button evolvewp-predictiveerp-button-small evolvewp-predictiveerp-button-secondary"><?php esc_html_e('Adjust', 'evolvewp-predictiveerp'); ?></button>
                        </div>
                    </div>
                    ...
                    <div class="interactive-tooltip-content" data-content="api-status">
                        ...
                        <div class="tooltip-actions">
                            <button class="evolvewp-predictiveerp-button evolvewp-predictiveerp-button-small evolvewp-predictiveerp-button-primary"><?php esc_html_e('Check Status', 'evolvewp-predictiveerp'); ?></button>
                        </div>
                    </div>
                </div>
            </div>
