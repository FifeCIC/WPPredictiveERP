<?php
/**
 * EvolveWP PredictiveERP Development Diagrams View
 *
...
class EvolveWP_ERP_Admin_Development_Diagrams {
    
    public static function output() {
        // Enqueue local Mermaid.js (download from https://cdn.jsdelivr.net/npm/mermaid@10/dist/mermaid.min.js)
        wp_enqueue_script('mermaid', EVOLVEWP_ERP_PLUGIN_URL . 'assets/js/mermaid.min.js', array(), '10.0.0', true);
        ?>
        <div class="evolvewp-predictiveerp-diagrams-container">
            <div class="diagrams-header">
                <h2><?php esc_html_e('EvolveWP PredictiveERP System Diagrams', 'evolvewp-predictiveerp'); ?></h2>
                <p><?php esc_html_e('Visual diagrams showing plugin architecture, data flow, and system processes.', 'evolvewp-predictiveerp'); ?></p>
            </div>
            
            <div class="diagram-controls">
                <select id="diagram-selector" class="regular-text">
                    <optgroup label="Architecture">
                        <option value="plugin-structure"><?php esc_html_e('Plugin Structure', 'evolvewp-predictiveerp'); ?></option>
                        <option value="class-hierarchy"><?php esc_html_e('Class Hierarchy', 'evolvewp-predictiveerp'); ?></option>
                        <option value="hook-system"><?php esc_html_e('Hook System', 'evolvewp-predictiveerp'); ?></option>
                    </optgroup>
                    <optgroup label="Data Flow">
                        <option value="data-flow"><?php esc_html_e('Data Flow Architecture', 'evolvewp-predictiveerp'); ?></option>
                        <option value="rest-api-flow"><?php esc_html_e('REST API Flow', 'evolvewp-predictiveerp'); ?></option>
                        <option value="admin-flow"><?php esc_html_e('Admin Interface Flow', 'evolvewp-predictiveerp'); ?></option>
                    </optgroup>
                    <optgroup label="Systems">
                        <option value="logging-system"><?php esc_html_e('Logging System', 'evolvewp-predictiveerp'); ?></option>
                        <option value="ai-integration"><?php esc_html_e('AI Integration', 'evolvewp-predictiveerp'); ?></option>
                        <option value="asset-management"><?php esc_html_e('Asset Management', 'evolvewp-predictiveerp'); ?></option>
                    </optgroup>
                </select>
                <button id="fullscreen-btn" class="button"><?php esc_html_e('Fullscreen', 'evolvewp-predictiveerp'); ?></button>
                <button id="export-btn" class="button"><?php esc_html_e('Export SVG', 'evolvewp-predictiveerp'); ?></button>
            </div>
        ...
        <style>
        .evolvewp-predictiveerp-diagrams-container { max-width: 100%; margin: 20px 0; }
        ...
        jQuery(document).ready(function($) {
            ...
            const diagrams = {
                'plugin-structure': {
                    ...
                    description: 'File and folder organization of EvolveWP PredictiveERP plugin',
                    mermaid: `
                        flowchart TD
                            A[evolvewp-predictiveerp/] --> B[includes/]
                            A --> C[admin/]
                            A --> D[assets/]
                            A --> E[api/]
                            A --> F[templates/]
                ...
                'class-hierarchy': {
                    ...
                    mermaid: `
                        flowchart TD
                            A[EvolveWPPredictiveERP] --> B[EvolveWP_ERP_Install]
                            A --> C[EvolveWP_ERP_Logger]
                            A --> D[EvolveWP_ERP_REST_Controller]
                            A --> E[EvolveWP_ERP_AI_Assistant]
                            
                            D --> F[EvolveWP_ERP_REST_Example]
                            D --> G[Custom REST Controllers]
                            
                            E --> H[EvolveWP_ERP_AI_Provider_Factory]
                            H --> I[EvolveWP_ERP_AI_Provider_Gemini]
                            H --> J[EvolveWP_ERP_AI_Provider_AmazonQ]
                ...
                'hook-system': {
                    ...
                    description: 'Actions and filters used throughout EvolveWP PredictiveERP',
                    mermaid: `
                        flowchart LR
                            A[WordPress Init] --> B[evolvewp_erp_loaded]
                            B --> C[evolvewp_erp_init]
                            C --> D[admin_menu]
                            C --> E[rest_api_init]
                ...
                'logging-system': {
                    ...
                    mermaid: `
                        flowchart TD
                            A[Event Occurs] --> B[EvolveWP_ERP_Logger]
                            B --> C{Log Level}
                            C -->|Error| D[Error Log]
                            C -->|Info| E[Info Log]
                            C -->|Debug| F[Debug Log]
                            
                            D --> G[File: evolvewp-predictiveerp-errors.log]
                            E --> H[File: evolvewp-predictiveerp-info.log]
                            F --> I[File: evolvewp-predictiveerp-debug.log]
                            
                            B --> J[Database Logger]
                            J --> K[wp_evolvewp_erp_logs table]
                ...
                'ai-integration': {
                    ...
                    mermaid: `
                        flowchart TD
                            A[AI Request] --> B[EvolveWP_ERP_AI_Assistant]
                            B --> C[EvolveWP_ERP_AI_Router]
                            C --> D{Task Type}
            ...
            $('#export-btn').on('click', function() {
                ...
                if (svg) {
                    ...
                    a.href = url;
                    a.download = 'evolvewp-predictiveerp-diagram.svg';
                    a.click();
